...
describe('Funciones con libros', () => {
  ...
  test('booksFromUser 12 devuelve un array vacÃ­o', () => {
  ...
  test('booksFromModule WECV devuelve un array vacÃ­o', () => {
  ...
  test('booksCheeperThan 1 devuelve un array vacÃ­o', () => {
  ...
  test('booksWithStatus new devuelve un array vacÃ­o', () => {
...
describe('Funciones con usuarios', () => {
  ...
  test('getUserById devuelve un objeto vacÃ­o si el usuario no existe', () => {
  ...
  test('getUserIndexById devuelve un objeto vacÃ­o si el usuario no existe', () => {
  ...
  test('getUserByNickName devuelve un objeto vacÃ­o si el usuario no existe', () => {
    expect(functions.getUserByNickName(users, 'Pep')).toEqual({});
  });
})

describe('Funciones con mÃ³dulos', () => {
  const modules = [
    {
      id: 4,
      code: 'DWEC'
  ...
  test('getModuleByCode encuentra un mÃ³dulo que existe', () => {
  ...
  test('getModuleByCode devuelve un objeto vacÃ­o si el mÃ³dulo no existe', () => {
    expect(functions.getModuleByCode(modules, 'AAAA')).toEqual({});
  });

  test('getModuleIndexByCode encuentra un mÃ³dulo que existe', () => {
    expect(functions.getModuleIndexByCode(modules, 'DWES')).toBe(1);
  });

  test('getModuleIndexByCode devuelve un objeto vacÃ­o si el mÃ³dulo no existe', () => {
